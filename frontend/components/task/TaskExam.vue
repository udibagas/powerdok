<template>
    ...
    <ExamDialog :task="task" :show="showDialog" />
        ...
        <div class="col">
          ...
          <h1>
            {{ task.exam.score }}
            <small>({{ task.exam.correct_answer }} / {{ task.exam.quizzes.length }})</small>
          </h1>
        </div>
        <div class="col">
        ...
        <div class="col-md-2">
          ...
          <h1 :class="{'text-success': task.exam.passed, 'text-danger': !task.exam.passed}">
            ...
            <i
              ...
              :class="{
                'el-icon-circle-check text-success' :
                  e.correct_answer == e.user_answer && task.status == TASK_STATUS.FINISHED,
          ...
          <div class="flex-grow-1">
            <div class="d-flex">
              <div class="mr-3 mb-3 flex-grow-1">
                ...
                <div class="row">
                  <div class="col-md-2" v-for="(url, i) in e.attachments" :key="i">
            ...
            <div class="row">
              <div v-for="(c, i) in e.choices" :key="i"
                class="col-5 mb-3 d-flex"
                :class="{
                  'text-success': e.user_answer == e.correct_answer == i,
                  'text-danger': e.user_answer != e.correct_answer && e.user_answer == i
                }"
              >
                <strong class="mr-2">
                  {{ ["A", "B", "C", "D"][i] }}.
