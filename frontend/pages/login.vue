...
<template>
<div>
    <div class="account-pages my-2 pt-sm-3">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <nuxt-link to="/" class="mb-3 d-block auth-logo">
                            <img src="~/assets/images/powerdok-dark.png" alt height="40" class="logo logo-dark" />
                            <img src="~/assets/images/powerdok-light.png" alt height="40" class="logo logo-light" />
                        </nuxt-link>
                    </div>
                </div>
            </div>
            <div class="row align-items-center justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Sign in to continue to Powerdok</p>
                            </div>
                            <div class="p-2 mt-4">
                    ...
                    <div class="mt-2 text-center">
                        <p>
                            Lamjaya Global Solusi © {{ new Date().getFullYear()}}
                        </p>
                    </div>
                    <!-- end row -->
                </div>
