...
export default {
	...
	methods: {
		triggerOpenFile() {
			...
			el.addEventListener("change", this.uploadAvatar);
			el.click();
		},
						...
						<div class="text-muted">
							...
							<div class="table-responsive mt-4 mb-0">
								...
								<div class="mt-4">
									...
									<h5 class="font-size-16">{{ $auth.user.position || "-" }}</h5>
								</div>
								...
								<div class="mt-4">
									...
									<h5 class="font-size-16">{{ $auth.user.mobile || "-" }}</h5>
								</div>
							...
							<div>
								<div data-simplebar style="max-height: 430px">
									<div class="media border-bottom py-4">
										<img
											class="mr-2 rounded-circle avatar-xs"
